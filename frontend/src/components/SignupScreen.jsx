...
export default function SignupScreen({ onLoginSuccess, switchToLogin }) {
  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
        ...
        <p style={{ color: 'var(--text-secondary)' }}>Sign up to begin your AI interview.</p>
      </div>
      ...
      <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
        Already have an account? <span onClick={switchToLogin} style={{ color: 'var(--accent-primary)', cursor: 'pointer', fontWeight: 'bold' }}>Log in</span>
      </div>
    </motion.div>
  );
}
